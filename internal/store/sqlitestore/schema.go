...
CREATE INDEX IF NOT EXISTS idx_browser_cookies_expires_at
	...
	// Version 42 → 43: asset_sessions table for Troy feature.
	42: `CREATE TABLE IF NOT EXISTS asset_sessions (
    id          TEXT NOT NULL PRIMARY KEY,
    tenant_id   TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_asset_sessions_asset ON asset_sessions (tenant_id, asset_id, asset_type);
CREATE INDEX IF NOT EXISTS idx_asset_sessions_session ON asset_sessions (tenant_id, session_key);`,
}
