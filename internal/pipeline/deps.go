...
type PipelineDeps struct {
	...
	InjectSessionState  func(ctx context.Context, input *RunInput) (string, error) // inject dynamic session state into system prompt (nil = disabled)
	...
	DetectSessionState       func(ctx context.Context, sessionKey string) // detect and persist session state changes (e.g. metadata.json created in sandbox)
